...
var endDate = "september 11, 2020 00:00:00";

$(document).ready(function () {

    $("#countdown").countdown({
        htmlTemplate: '<div id="countdown_day" class="countdown count"><div><span>%d</span>Days</div></div><div id="coundown_hour" class="countdown count"><div><span>%h</span>Hours</div></div><div id="coundown_sec" class="countdown count c_last"><div><span>%s</span>Sec</div></div>',
        date: endDate,
        hoursOnly: false,
        leadingZero: true
    });
